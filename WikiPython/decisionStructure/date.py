...
def validate(date):
   ...
   try:
      ...
      if day == 0:
       ...
       msg = '[data inválida] --- o mês "2" tem apenas 28 dias (exceto em anos bissextos).'
       ...
       msg = '[data inválida] --- o ano não é bissexto, logo, você não pode colocar o dia 29 no mês 2.'
     

      return print(msg)
    
   except:
      date = print('ocorreu um erro ao tentar pegar o formato dessa data... Verifique se você colocou uma data no formato dd/mm/yyyy (exemplo: 15/10/2020).')
